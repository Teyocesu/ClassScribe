...
- [x] Fase 2D **COMPLETE / PARTIAL**: separar master source-rate/stereo durable (`master.raw` + manifest) del derivado ASR 16 kHz mono (`source.wav`); gates Windows runtime/físicos, CATap global físico macOS, TCC y hardware/device-change permanecen pendientes.
