...
- [x] Fase 2C.2 **COMPLETE / PARTIAL**: elección online aplicación/audio del equipo, modal de privacidad por intento, capability efímero ligado al intento y CTA `Capturar audio del equipo`; sin transición automática ni hot-switch. macOS local PASS; Windows tests/static review PASS y runtime SKIPPED — dotnet/csc unavailable.
